...
public class SQLiteConnectionPool {
    public static let shared = SQLiteConnectionPool()

    private var connectedDatabases = Set<SQLiteConnection>()
    private var queue = DispatchQueue(label: "com.aprearo.ConnectionPool.queue", qos: .background, attributes: .concurrent)
